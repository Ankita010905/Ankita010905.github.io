...
EDA / VLSI Tools: Xilinx ISE, Microwind 3.1, DSCH2, Intel Quartus
Simulation Tools: MATLAB, Simulink, ETAP, LabVIEW
Embedded Systems: Arduino, Sensors, FPGA Basics, ESP32, ESP8266
...
Conducted data analysis and visualization, generating plots, graphs, and statistical summaries from datasets.
Enhanced practical skills in MATLAB programming, signal processing, image processing, and simulation
workflows.
...
4. Integrating, Modelling and Control of a BLDC Motor Driven Electric Vehicle | December 2025 – Present
...
6. MATLAB and Its Application in Engineering at NIST University | August 2024 | Course on MATLAB applications in various engineering fields 7.Introduction to Python Programming by CODETECH | February 2024 | Introduction course on Python programming for beginners 
